               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <p>Once you"re registered, you can enjoy exploring good meeals.</p>
                        <hr>
                        <img src="admin/Res_img/eating.svg" alt="" class="img-fluid">
                        <p></p>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    ...
                    <div class="col-xs-12 col-sm-2 about color-gray">
                        <h5>About Us</h5>
                        <ul>
                            <li><a href="#">We are a team of enthusiastic developers</a> </li>  
                            <li><a href="#">Shallani Devi</a> </li> 
                            <li><a href="#">Preethy Ray</a> </li> 
                            <li><a href="#">Vidisha Prabhu</a> </li> 
                        </ul>
                    </div>
                    <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Pay by credit/debit card</a> </li>
                    ...
                    <div class="col-xs-12 col-sm-2 pages color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Resturants Page</a> </li>
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                            <li><a href="#">Padil</a> </li>
                            <li><a href="#">Farangipette</a> </li>
                            <li><a href="#">Bantwal</a> </li>
                            <li><a href="#">Kadri</a> </li>
                            <li><a href="#">Hampankatte</a> </li>
                            <li><a href="#">Attavar</a> </li>
                            <li><a href="#">State Bank</a> </li>
                            <li><a href="#">Bajpe</a> </li>
                            <li><a href="#">Falnir</a> </li>
                            <li><a href="#">Ullal</a> </li>
                        </ul>
                    </div>
                </div>
                <!-- top footer ends -->
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>Concept design of online food order website and database</p>
                            <h5>Phone: <a href="tel:+0000000000">00000 00000</a></h5> </div>
